                ...
                Form(
                  ...
                  child: Column(
                    children: [
                      TextFormField(
                        controller:
                            ref.watch(registerViewModel).emailController,
                      ...
                      TextFormField(
                        controller:
                            ref.watch(registerViewModel).firstNameController,
                        decoration: InputDecoration(
                          filled: true,
                          fillColor: Color.fromRGBO(247, 248, 249, 1),
                          hintText: 'First Name',
                      ...
                      TextFormField(
                        controller:
                            ref.watch(registerViewModel).lastNameController,
                        decoration: InputDecoration(
                          filled: true,
                          fillColor: Color.fromRGBO(247, 248, 249, 1),
                          hintText: 'Last Name',
                      ...
                      TextFormField(
                        ...
                        controller:
                            ref.watch(registerViewModel).passwordController1,
                        decoration: InputDecoration(
                      ...
                      TextFormField(
                        ...
                        controller:
                            ref.watch(registerViewModel).passwordController2,
                        decoration: InputDecoration(
                          suffixIcon: IconButton(
                            color: Colors.grey,
                            onPressed: () {
                        ...
                        onPressed: checkboxValue
                            ? () {
                                if (_key.currentState!.validate()) {
                                  ref.read(registerViewModel).registerUser();
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
